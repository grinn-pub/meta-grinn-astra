...
do_compile:prepend:grinn-astra-1680-ada() {
	cp ${WORKDIR}/${ASTRA}.dtsi ${DT_DIR}/
	cp ${WORKDIR}/${ASTRA_ADA}.dts ${DT_DIR}/
	cp ${WORKDIR}/${ASTRA_ADA}_defconfig ${CFG_DIR}/
}

do_compile:prepend:grinn-astra-1680-evb() {
	cp ${WORKDIR}/${ASTRA}.dtsi ${DT_DIR}/
	cp ${WORKDIR}/${ASTRA_EVB}.dts ${DT_DIR}/
	cp ${WORKDIR}/${ASTRA_EVB}_defconfig ${CFG_DIR}/
}
